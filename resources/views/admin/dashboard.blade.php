						...
						<div class="row">
								...
								<div class="card">
									<div class="card-body d-flex align-items-center justify-content-between">
										<div class="menu">
											...
											<h2>{{  number_format((\App\Models\Investment::where('status','Active')->sum('amount')),2)   }} <span style="font-size:17px">{{ currency() }} </span></h2>
										</div>	
										<div class="d-inline-block position-relative donut-chart-sale">
							...
							<div class="col-xl-4 col-sm-4">
								<div class="card">
									<div class="card-body d-flex align-items-center justify-content-between">
										<div class="menu">
											<span class="font-w500 fs-16 d-block mb-2">Total Team Build Income</span>
											<h2>{{  number_format((\App\Models\Income::where('remarks','Team Build Income')->sum('comm')),2)   }} <span style="font-size:17px">{{ currency() }} </span></h2>
										</div>	
										<div class="d-inline-block position-relative donut-chart-sale">
							...
							<div class="col-xl-4 col-sm-4">
								<div class="card">
									<div class="card-body d-flex align-items-center justify-content-between">
										<div class="menu">
											<span class="font-w500 fs-16 d-block mb-2">Total Global Income</span>
											<h2>{{  number_format((\App\Models\Income::where('remarks','Global Income')->sum('comm')),2)   }} <span style="font-size:17px">{{ currency() }} </span></h2>
										</div>	
										<div class="d-inline-block position-relative donut-chart-sale">
								...
								<div class="card">
									<div class="card-body d-flex align-items-center justify-content-between">
										<div class="menu">
											...
											<h2>{{  number_format((\App\Models\Withdraw::where('status','Pending')->sum('amount')),2)   }} <span style="font-size:17px">{{ currency() }} </span></h2>
										</div>	
										<div class="d-inline-block position-relative donut-chart-sale">
								...
								<div class="card">
									<div class="card-body d-flex align-items-center justify-content-between">
										<div class="menu">
											...
											<h2>{{  number_format((\App\Models\Withdraw::where('status','Approved')->sum('amount')),2)   }} <span style="font-size:17px">{{ currency() }} </span></h2>
										</div>	
										<div class="d-inline-block position-relative donut-chart-sale">
