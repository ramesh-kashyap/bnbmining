                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="{{ route('admin.activate-admin') }}" method="POST">
                                     {{ csrf_field() }}
                                        <div class="row">
                                            <div class="mb-3 col-md-12">
                                                ...
                                                <select name="amount"  required class="form-control package-1" onchange="change_language(this.value);">
                                                         ...
                                                         <option value="4"> 4 <span style="font-size: 12px"> {{ currency() }}</span></option>
                                                         <option value="10"> 10 <span style="font-size: 12px"> {{ currency() }}</span></option>
                                                         <option value="25"> 25 <span style="font-size: 12px"> {{ currency() }}</span></option>
                                                         <option value="80"> 80 <span style="font-size: 12px"> {{ currency() }}</span></option>
                                                         <option value="200"> 200 <span style="font-size: 12px"> {{ currency() }}</span></option>
                                                         <option value="400"> 400 <span style="font-size: 12px"> {{ currency() }}</span></option>
                                                         <option value="700"> 700 <span style="font-size: 12px"> {{ currency() }}</span></option>
                                                         <option value="1000"> 1000 <span style="font-size: 12px"> {{ currency() }}</span></option>
