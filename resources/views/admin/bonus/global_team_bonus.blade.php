            ...
            <div class="container-fluid">
				...
				<div class="row page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="javascript:void(0)">Team Build Income</a></li>
					</ol>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Global Team Boost Income</h4>
                            </div>
                            <div class="card-body">
                                <div id="example_wrapper" class="dataTables_wrapper" style="display: block">
                                    <form action="{{ route('admin.global_team_bonus') }}" method="GET">
                                        <div class="row">
                                            <div class="col-xl-4">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($level_incomes as $value)
                                                <tr>
                                                    ...
                                                    <td>  {{ $value->amt }} <span style="font-size: 12px">{{currency()}}</span> </td>
